...
@section('content')
    <div class="row">
        <aside class="col-xs-4">
            ...
            @include('user_favorited.favorited_button', ['user' => $user])
        </aside>
        <div class="col-xs-8">
            <ul class="nav nav-tabs nav-justified">
                ...
                <li role="presentation" class="{{ Request::is('users/*/favorited') ? 'active' : '' }}"><a href="{{ route('users.favorited', ['id' => $user->id]) }}">Favorited <span class="badge">{{ $count_favorited }}</span></a></li>
            </ul>
